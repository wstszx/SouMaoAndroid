...
public class GenerateValueFiles {
	// 竖屏文件的输出路径
	private final static String rootPathPort = "storage/emulated/0/values-port-{0}dpi-{1}x{2}/";
	// 横屏文件的输出路径
	private final static String rootPathLand = "storage/emulated/0/values-land-{0}dpi-{1}x{2}/";
	// 水平方向（X）的值
