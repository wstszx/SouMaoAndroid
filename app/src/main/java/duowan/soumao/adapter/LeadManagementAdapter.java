...
public class LeadManagementAdapter extends SimpleRecAdapter<GankResults.Item, LeadManagementAdapter.ViewHolder> {

    public static final int TAG_VIEW = 0;

    public LeadManagementAdapter(Context context) {
        super(context);
    }
